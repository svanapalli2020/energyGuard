...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'digital-products' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'digital-products' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'digital-products' ),
		'cyrillic'     => __( 'Cyrillic', 'digital-products' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'digital-products' ),
		'devanagari'   => __( 'Devanagari', 'digital-products' ),
		'greek'        => __( 'Greek', 'digital-products' ),
		'greek-ext'    => __( 'Greek Extended', 'digital-products' ),
		'khmer'        => __( 'Khmer', 'digital-products' ),
		'latin'        => __( 'Latin', 'digital-products' ),
		'latin-ext'    => __( 'Latin Extended', 'digital-products' ),
		'vietnamese'   => __( 'Vietnamese', 'digital-products' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'digital-products' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'digital-products' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'digital-products' ),
